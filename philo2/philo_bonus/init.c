...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/17 12:07:50 by bukurekc          #+#    #+#             */
/*   Updated: 2023/07/17 12:07:52 by bukurekc         ###   ########.tr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_init_eatthread(t_data *data)
{
	...
	{
		if (pthread_create(&data->mealchecker_tid, NULL, &ft_eatchecker, data))
		{
